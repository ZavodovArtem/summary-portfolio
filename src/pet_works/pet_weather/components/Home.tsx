...
function Home () {
    return (
        <>
            ...
            <img className='imgTu1' src= {tu}  alt="" />
            <img className='imgTu2' src={tu}  alt="" />
            <img className='imgBl' src={bl} alt="" />
            ...
            <img className='imgGr' src={gr}  alt="" />
            ...
            <Parallax bgImage='img/pole.jpg' strength={350}>
                ...
                <div className='main scroll'>
                    <Scrollup /> 
                    <a className='resume' href='/'>В резюме</a>
                </div>
            </Parallax>
        </>
    );
